                ...
                <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
                    <div className="relative mb-6 sm:mb-0">
                        <div className="bg-linear-to-b aspect-76/59 relative rounded-2xl from-zinc-300 to-transparent p-px dark:from-zinc-700">
                            <img src="/images/payments.webp" className="hidden rounded-[15px] dark:block" alt="payments illustration dark" width={1207} height={929} />
                            <img src="/images/payments-light.webp" className="rounded-[15px] shadow dark:hidden" alt="payments illustration light" width={1207} height={929} />
                        </div>
                    </div>
                        ...
                        <div className="pt-6">
                            <blockquote className="border-l-4 pl-4">
                                ...
                                <div className="mt-6 space-y-3">
                                    ...
                                    <img className="h-5 w-fit dark:invert" src="https://toppng.com/uploads/preview/nvidia-logo-vector-11574170524xza1ggbhhk.png" alt="Nvidia Logo" height="20" width="auto" />
                                </div>
                            </blockquote>
                        </div>
                    </div>
